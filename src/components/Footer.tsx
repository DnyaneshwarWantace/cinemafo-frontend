        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/" className="text-white hover:text-gray-300 transition-colors text-sm font-bold">Home</a></li>
              <li><a href="/search" className="text-white hover:text-gray-300 transition-colors text-sm font-bold">Search</a></li>
              <li><a href="/movies" className="text-white hover:text-gray-300 transition-colors text-sm font-bold">Movies</a></li>
              <li><a href="/shows" className="text-white hover:text-gray-300 transition-colors text-sm font-bold">TV Shows</a></li>
              <li><a href="/watchlist" className="text-white hover:text-gray-300 transition-colors text-sm font-bold">Watchlist</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              {/* Fallback message if no social links configured */}
              {(!socialLinks?.discord && !socialLinks?.telegram) && (
