            ...
            {referrals.map((referral) => (
              <div key={referral._id} className="border border-gray-700 rounded-lg p-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="flex gap-2">
                    <Button
                      size="sm"
                      variant="outline"
                      onClick={() => copyToClipboard(`${BACKEND_SERVER_URL}/referral/${referral.code.toLowerCase()}`)}
                    >
                ...
                <div className="text-sm text-gray-400">
                  <p>Link: <span className="font-mono text-blue-400">{BACKEND_SERVER_URL}/referral/{referral.code.toLowerCase()}</span></p>
