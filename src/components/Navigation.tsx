      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center space-x-2">
              <Button 
                ...
                className={`text-white/90 hover:text-red-500 font-medium px-4 py-2 rounded-lg transition-all duration-200 ${
                  isActive('/') ? 'text-red-500' : 'hover:scale-105'
                }`}
                onClick={() => navigate('/')}
              >
              ...
              <Button 
                variant="ghost" 
                className={`text-white/90 hover:text-red-500 font-medium px-4 py-2 rounded-lg transition-all duration-200 ${
                  isActive('/movies') ? 'text-red-500' : 'hover:scale-105'
                }`}
              ...
              <Button 
                variant="ghost" 
                className={`text-white/90 hover:text-red-500 font-medium px-4 py-2 rounded-lg transition-all duration-200 ${
                  isActive('/shows') ? 'text-red-500' : 'hover:scale-105'
                }`}
              ...
              <Button 
                variant="ghost" 
                className={`text-white/90 hover:text-red-500 font-medium px-4 py-2 rounded-lg transition-all duration-200 ${
                  isActive('/search') ? 'text-red-500' : 'hover:scale-105'
                }`}
          ...
          <Button 
            ...
            className="text-white/90 hover:text-red-500 p-3 rounded-full hover:scale-110 transition-all duration-200"
          >
