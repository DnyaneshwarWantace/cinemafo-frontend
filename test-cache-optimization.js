...
console.log('Movies Page: 3 API calls (trending movies, popular movies, top-rated movies)');
console.log('Shows Page: 3 API calls (trending shows, popular shows, top-rated shows)');
console.log('Total: 10 API calls');

console.log('\n📊 AFTER OPTIMIZATION:');
console.log('Home Page: 4 API calls (trending movies, popular movies, trending shows, popular shows)');
console.log('Movies Page: 1 API call (top-rated movies only, trending/popular from cache)');
console.log('Shows Page: 1 API call (top-rated shows only, trending/popular from cache)');
...
console.log('- Only fetch new data (top-rated) when needed');
